...
const ProfileScreen = () => {
  ...
  const profileMenuOptions = [
    { id: "1", title: "مجموعاتي", icon: "people", color: colorPalette.primaryBlue },
    { id: "2", title: "الأصدقاء", icon: "person", color: colorPalette.primaryBlue },
    {
      id: "3",
      title: "الإعدادات",
      icon: "settings",
        ...
        <View style={styles.profileHeaderSection}>
          <View style={styles.userInformation}>
            ...
            <TouchableOpacity onPress={handleEmailCopy}>
              <Text style={styles.userEmailText}>{shortName(userProfileData.email)}</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.menuOptionsContainer}>
          {profileMenuOptions.map((menuItem) => (
            ...
            >
              ...
              <Ionicons name="chevron-back" size={16} color={colorPalette.borderLightGray} />
            </TouchableOpacity>
          ))}
        </View>
        ...
        <View style={styles.quickActionsContainer}>
          ...
          <View style={styles.quickActionsRow}>
            <TouchableOpacity style={styles.quickActionButton}>
              <View
                style={[styles.quickActionIcon, { backgroundColor: colorPalette.primaryBlue }]}
              >
            ...
            <TouchableOpacity style={styles.quickActionButton} onPress={handleEmailSend}>
              <View
                style={[styles.quickActionIcon, { backgroundColor: colorPalette.primaryBlue }]}
              >
